            ...
            <table class="table mb-0 table-bordered">
              ...
              <tbody>
                <tr v-for="cartitem in item.cart" :key="cartitem.name">
                  ...
                  <td>{{ cartitem.totalPrice }} BAHT</td>
                </tr>
                <tr>
                  <td colspan="2" class="table-active">
                    Total Price (shipping included)
                  </td>
                  <td>{{ item.total }} BAHT</td>
                </tr>
              </tbody>
            </table>
          </td>
                  ...
                  <div class="invoice-header">
                    <div class="invoice-from">
                      ...
                      <address class="m-t-5 m-b-5">
                        <strong class="text-inverse">PetShop , CNX</strong><br />
                        Address: Sansai, Chiang-Mai<br />
                        Phone: (+66) 25 239 874
                      </address>
                    </div>
                    <div class="invoice-to">
                      ...
                      <address class="m-t-5 m-b-5">
                        ...
                        Phone: (+66) {{ productdata.number }}
                      </address>
                    </div>
                    <div class="invoice-date">
                      <small>Invoice / March period</small>
                        ...
                        <div class="invoice-price-row">
                          <div class="sub-price">
                            ...
                            <span class="text-inverse"
                              >{{ productdata.total - 120 }} BAHT</span
                            >
                          </div>
                          <div class="sub-price">
                          ...
                          <div class="sub-price">
                            ...
                            <span class="text-inverse">120 BAHT</span>
                          </div>
                        </div>
                      </div>
                      <div class="invoice-price-right">
                        <small>TOTAL</small>
                        <span class="f-w-600">{{ productdata.total }} BAHT</span>
                      </div>
                    </div>
                    <!-- end invoice-price -->
                  </div>
                  ...
                  <div class="invoice-footer">
                    ...
                    <p class="text-center">
                      <span class="m-r-10"
                        ...
                        www.PetShop.com</span
                      >
                      <span class="m-r-10"
                        ><i class="fa fa-fw fa-lg fa-phone-volume"></i>
                        Tel:(+66) 25 239 874</span
                      >
                      <span class="m-r-10"
                        ><i class="fa fa-fw fa-lg fa-envelope"></i>
                       PetShop_CNX@gmail.com</span
                      >
                    </p>
                  </div>
                  <!-- end invoice-footer -->
