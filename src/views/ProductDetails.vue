...
PetShop/src/views/ProductDetails.vue
@MJUMimo
MJUMimo init project
Latest commit 3349780 yesterday
 History
 1 contributor
343 lines (333 sloc)  8.9 KB
            ...
            <div class="row g-0">
              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <br />
                  <h6 class="card-text">Price : {{ product.price }} BAHT</h6>
                  <p class="card-text">
...
Blog
About
PetShop/ProductDetails.vue at master · MJUMimo/PetShop